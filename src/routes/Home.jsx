      ...
      <div className="mb-5 px-16 grid-rows-2 grid">
        <div className="grid grid-cols-3 w-full justify-center items-center">
          <button
            ...
            className="border-4 bg-clip-border bg-gradient-to-r from-fuchsia-500 via-purple-400 to-sky-400"
          >
          ...
          <button
            ...
            className="bg-white hover:bg-slate-100 text-black px-5 py-4 rounded-full w-full font-medium text-xl transition-all duration-200"
          >
            Security
          </button>
          <button
