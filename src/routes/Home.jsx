...
export const Home = () => {
  ...
  return (
    <div>
      <div className="grid md:grid-cols-3 w-full h-screen place-items-center gap-5 container mx-auto pb-5 overflow-hidden md:px-3 lg:px-5">
        <div
        ...
        {!tryBrowser && (
          <div className="absolute md:relative mx-5">
            <span className="text-4xl md:text-5xl xl:text-7xl font-bold bg-gray-800 md:bg-transparent text-white md:text-slate-800 dark:md:text-white">
              Your PC, even{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
                better
              </span>
            </span>
            <p className="text-sm dark:text-slate-400 text-black mt-3 mb-10">
            ...
            <a
              href="https://dynamicos.netlify.app/"
              className="bg-gradient-to-r bg-size-200 bg-pos-0 from-blue-500 to-indigo-800 p-3 font-medium rounded-md hover:bg-pos-100 transition-all duration-150 px-5 cursor-pointer focus:outline-none focus:ring-rose-600 focus:border-4 focus:border-rose-600 text-center text-sm lg:text-lg text-white inline-block"
            >
              <i className="fa-solid fa-window-maximize mr-2"></i> Try it in
              your browser
            </a>
          ...
          {faq.map((el, index) => (
            <div key={index} className="row-span-1">
              <button
                ...
                } rounded-md flex justify-between w-full focus:outline-none focus:ring-rose-600 focus:border-4 focus:border-rose-600 text-white`}
              >
      ...
      <div className="bg-gradient-to-r from-blue-600 via-violet-700 to-rose-600 text-white">
